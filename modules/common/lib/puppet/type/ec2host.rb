  ...
  newtype(:ec2host) do
    ...
    newproperty(:target) do
      desc "The file in which to store service information.  Only used by
        those providers that write to disk. On most systems this defaults to `/etc/cloud/templates/hosts.tmpl`."
    ...
    @doc = "Installs and manages host entries.  For most systems, these
      entries will just be in `/etc/cloud/templates/hosts.tmpl`, but some systems (notably OS X)
